...
class __TwigTemplate_28e93ba160cc612e6f589736498c2f66 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        $this->loadTemplate("security/logout.html.twig", "product/show.html.twig", 7)->display($context);
        // line 8
        echo "

    <center><h1 class=\"display-4\">Product info</h1></center></br>
    ...
    <div class=\"buttons\" style=\"margin-bottom:2em\">
        ...
        <a href=\"";
        // line 15
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_product_edit", ["id" => twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 15, $this->source); })()), "id", [], "any", false, false, false, 15)]), "html", null, true);
    ...
    <table class=\"table table-success table-hover text-center\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <th>";
        // line 32
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 32, $this->source); })()), "category", [], "any", false, false, false, 32), "html", null, true);
        echo "</th>
            </tr>
            <tr>
                <th>Created_at</th>
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 40
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, (isset($context["product"]) || array_key_exists("product", $context) ? $context["product"] : (function () { throw new RuntimeError('Variable "product" does not exist.', 40, $this->source); })()), "stock", [], "any", false, false, false, 40), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "product/show.html.twig", "/Users/alex/Desktop/gac-travel-technical-interview/templates/product/show.html.twig");
    }
}
