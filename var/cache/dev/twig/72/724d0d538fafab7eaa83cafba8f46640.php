...
class __TwigTemplate_f7fd0621e893974a8fae8734713ff90a extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "    ";
        $this->loadTemplate("security/logout.html.twig", "category/edit.html.twig", 6)->display($context);
        // line 7
        echo "    


    <center><h1 class=\"display-4\">Category management</h1></center></br>
    ...
    <div class=\"form-control-lg\">
         ...
         ";
        // line 21
        echo twig_include($this->env, $context, "category/_form.html.twig", ["button_label" => "Edit"]);
        echo "
...
{% block body %}
    ...
    <div class=\"btn-group\" role=\"group\" style=\"margin-bottom:2em\">
        <a href=\"{{ path('app_product_index') }}\"><button class=\"btn btn-outline-secondary\">{{ button_label|default('Categories') }}</button></a>
    ...
    <div class=\"form-control-lg\">
         ...
         {{ include('category/_form.html.twig', {'button_label': 'Edit'}) }}

    </div>


{% endblock %}", "category/edit.html.twig", "/Users/alex/Desktop/gac-travel-technical-interview/templates/category/edit.html.twig");
    }
}
