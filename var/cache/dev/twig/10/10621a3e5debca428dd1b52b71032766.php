...
class __TwigTemplate_ca61be6358b46732ddf3cd5ec3f1b044 extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 7
        $this->loadTemplate("security/logout.html.twig", "product/new.html.twig", 7)->display($context);
        // line 8
        echo "    
    <center><h1 class=\"display-4\">Product register</h1></center></br>

    <Form method=\"post\" onsubmit=\"return confirm('Product registered succesfully');\">
    ...
    <div class=\"btn-group\" role=\"group\" style=\"margin-bottom:2em\">
        ...
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 15, $this->source); })()), "Products")) : ("Products")), "html", null, true);
        echo "</button></a>
...
{% endblock %}
", "product/new.html.twig", "/Users/alex/Desktop/gac-travel-technical-interview/templates/product/new.html.twig");
    }
}
